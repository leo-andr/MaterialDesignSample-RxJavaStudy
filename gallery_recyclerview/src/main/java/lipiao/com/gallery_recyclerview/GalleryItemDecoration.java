...
import lipiao.com.gallery_recyclerview.util.OsUtil;
...
public class GalleryItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void onSetHoritiontalParams(ViewGroup parent, View itemView, int position, int itemCount) {
        ...
        DLog.d(TAG, "onSetHoritiontalParams -->" +
                "\nparent.width=" + parent.getWidth() +
                "\nparent.height=" + parent.getHeight() +
                "\nmPageMargin=" + OsUtil.dpToPx(mPageMargin) +
                "\nmLeftVis=" + OsUtil.dpToPx(mLeftPageVisibleWidth) +
